/*
 * FirefoxIcon Functional Component
 * This component displays the SVG for the Firefox Icon.
 */

import React from 'react';
import styled from 'styled-components';

const StyledFirefoxIcon = styled.svg`
  max-width: 60px;
  width: 100%;
  max-height: 50px;
`;
...
const firefoxIcon = ( props ) => {
  return(
    <StyledFirefoxIcon viewBox="0 0 1024 1024">
      <defs>
        <radialGradient id="a" cx="-14480.522" cy="-8329.079" fx="-14509.281" r="450.875" gradientTransform="matrix(.762 .034 -.05 1.12 11560.893 10069.103)" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id="c" x1="575.669" y1="731.188" x2="384.231" y2="104.96" gradientUnits="userSpaceOnUse">
        ...
        <radialGradient id="g" cx="750.189" cy="396.041" fx="778.167" fy="382.212" r="782.18" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id="i" x1="-8944.65" y1="-6677.742" x2="-8660.289" y2="-6750.226" gradientTransform="rotate(5.67 -90364.99 106952.151) scale(1.225)" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id="j" x1="245.347" y1="-1082.012" x2="190.775" y2="-1221.859" gradientTransform="rotate(5.73 -13193.275 -1077.296)" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#891551" stopOpacity=".6"/>
          <stop offset="1" stopColor="#c42482" stopOpacity="0"/>
        </linearGradient>
        <linearGradient id="k" x1="22.04" y1="718.827" x2="116.148" y2="825.714" gradientTransform="rotate(5.73 2610.902 2923.845)" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id="l" x1="200.104" y1="904.616" x2="200.171" y2="829.835" gradientTransform="rotate(5.73 2610.902 2923.845)" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id="m" x1="655.531" y1="38.12" x2="961.187" y2="721.615" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id="n" x1="715.885" y1="431.21" x2="571.098" y2="819.96" gradientUnits="userSpaceOnUse">
      ...
      <path d="M512.592 321.373c.393-8.77-4.156-14.66-76.682-21.463-29.839-2.755-41.265-30.334-44.748-41.941-10.61 27.565-14.991 56.49-12.636 91.477 1.61 22.92 17.009 47.521 24.37 61.965 0 0 1.636-2.126 2.391-2.912 13.861-14.431 71.936-36.419 77.392-39.541 6.014-3.799 28.903-20.523 29.913-47.585z" fill="url(#i)"/>
      <path d="M193.314 158.471c-1.041-1.818-1.6 3.754-2.4 1.961-5.955-13.813-9.578-36.2-8.72-52.022 0 0-12.318 5.614-22.513 29.06-1.893 4.215-3.107 6.54-4.32 8.865-.558.678 1.265-7.7.974-7.244-1.771 3-6.355 7.192-8.346 12.375-1.651 4.239-3.349 6.515-4.613 11.772-.389 1.429.392-6.323.052-5.379-23.711 45.825-28.237 115.114-25.738 112.184 50.478-53.9 108.325-66.683 108.325-66.683-6.155-4.534-19.528-17.625-32.7-44.889z" fill="url(#j)"/>
      <path d="M384.844 722.1c-69.724-29.769-148.992-71.755-146-167.138 4.075-125.619 117.145-100.791 117.145-100.791-4.267 1.039-15.675 9.162-19.718 17.82-4.273 10.827-12.069 35.276 11.551 60.9 37.089 40.192-76.2 95.356 98.663 199.567 4.41 2.4-40.991-1.43-61.639-10.358z" fill="url(#k)"/>
      <path d="M360.074 659.5c49.442 17.207 107.04 14.189 141.523-4.858 23.085-12.851 52.7-33.434 70.922-28.353-15.777-6.236-27.726-9.15-42.1-9.862-2.448 0-5.382-.052-8.048-.32a136.228 136.228 0 0 0-15.757.863c-8.9.818-18.766 6.433-27.735 5.532-.485-.049 8.7-3.774 7.953-3.605-4.752.991-9.915 1.205-15.37 1.881-3.467.386-6.449.82-9.891.963-102.982 8.733-190.017-55.813-190.017-55.813-7.408 24.95 33.166 74.3 88.521 93.572z" fill="url(#l)"/>
      <path d="M848.738 803.646C952.9 701.376 1005.6 577.061 983.321 437.627c0 0 8.9 71.5-24.848 144.628 16.213-71.393 18.1-160.114-24.975-251.988-57.493-122.631-152.048-187.158-188.147-214.078C690.656 75.4 667.983 33.87 667.574 25.3c-16.339 33.477-65.766 148.2-5.31 247 56.64 92.564 145.865 120.039 208.328 204.947 115.075 156.42-21.854 326.399-21.854 326.399z" fill="url(#m)"/>
      <path d="M833.814 537.551C797.412 462.35 751.978 429.55 709 394c5 7 6.232 9.473 9 14 37.827 40.316 93.607 138.656 53.11 262.107-76.229 232.375-381.143 122.95-413.11 92.212 12.932 134.489 238.036 198.845 384.6 111.63C826 795 893.468 660.788 833.814 537.551z" fill="url(#n)"/>
    </StyledFirefoxIcon>
  );
}
